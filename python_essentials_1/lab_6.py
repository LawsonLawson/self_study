...
be completed with the instructions implementing the test we've just described.
...
and output a warning otherwise: Not within the Gregorian calendar period. Tip:
...
try:
    ...
    if year <= 1582:
        print("Not within the Gregorain calender")
    else:
        if year % 4 != 0:
            print("Common year")
        elif year % 100 != 0:
